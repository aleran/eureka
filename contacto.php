...
if(isset($_POST['enviar'])){
	...
	$para = "info@eurekalibros.com.co";//Email al que se enviará
...
//Cabeceras del correo
    $headers = "From: $nombre <mail@eurekadigital.com.co>\r\n"; //Quien envia?
...
//Comprobamos que los datos enviados a la función MAIL de PHP estén bien y si es correcto enviamos
	if(mail($para, $asunto, $mensaje, $headers)){
		echo "<script>alert('Mensaje enviado correctamente, Gracias por contactarnos');window.location='index.html'</script>";
	}else{
		echo "<script>alert('Hubo un error en el envío inténtelo más tarde');window.location='index.html'</script>";
	}
}
}	
?>
