...
{else}
	...
	<section class="bottom-footer col-xs-12">
		<div>
			{l s='[1] %3$s %2$s - Tienda creada por %1$s [/1]' mod='blockcms' sprintf=['Artech Soluciones S.A.S', 'Y'|date, '©'] tags=['<a class="_blank" href="https://www.solucionesartech.com">'] nocache}
		</div>
	</section>
	{/if}
	<!-- /Block CMS module footer -->
