...
<div class="addresses clearfix">
	...
	{if !$opc}
		<div id="ordermsg" class="form-group">
			<label>{l s='Nombre, colegio y curso de los estudiantes para los que realiza la compra (esta información es necesaria para habilitar la plataforma virtual) *'}</label> <a href="https://eurekadigital.com.co/tienda/index.php?id_cms=4&controller=cms" target="_blank">POLÍTICA DE PROTECCION DE DATOS</a>
			<textarea class="form-control" cols="60" rows="6" name="message" required>{if isset($oldMessage)}{$oldMessage}{/if}</textarea>
		</div>
