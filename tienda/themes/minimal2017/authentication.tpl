		...
		{if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
			...
			<div class="account_creation">
				...
				<p class="form-group">
					...
					<textarea class="form-control" id="company" name="company" cols="26" rows="3"value="{if isset($smarty.post.company)}{$smarty.post.company}{/if}" data-validate="isName"></textarea>
				
					
				</p>
				<p class="form-group">
					<label for="siret">{l s='SIRET'} <sup>*</sup></label>
