							...
							<div class="row">
								...
								<nav>{$smarty.capture.displayNav}</nav>
									<a href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}" title="{$shop_name|escape:'html':'UTF-8'}">
										<img class="logo img-responsive" src="themes/minimal2017/logo_eureka.png" alt="{$shop_name|escape:'html':'UTF-8'}"{if isset($logo_image_width) && $logo_image_width} {/if}{if isset($logo_image_height) && $logo_image_height} {/if} style="padding-left: 30px" />
									</a>
								</div>
								{if $is_logged}
