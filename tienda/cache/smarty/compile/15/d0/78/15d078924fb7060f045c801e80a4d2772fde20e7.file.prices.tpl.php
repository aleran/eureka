<?php /* Smarty version Smarty-3.1.19, created on 2018-01-11 07:31:55
         compiled from "/var/www/vhosts/eurekadigital.com.co/httpdocs/tienda/admineureka/themes/default/template/controllers/products/prices.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21102993685a57593b703019-58681571%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '15d078924fb7060f045c801e80a4d2772fde20e7' => 
    array (
      0 => '/var/www/vhosts/eurekadigital.com.co/httpdocs/tienda/admineureka/themes/default/template/controllers/products/prices.tpl',
      1 => 1509593610,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21102993685a57593b703019-58681571',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a57593b9d1251_87546555',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a57593b9d1251_87546555')) {function content_5a57593b9d1251_87546555($_smarty_tpl) {?>
...
"/>
				<input size="11" maxlength="27" id="priceTE" name="price_displayed" type="text"  onchange="noComma('priceTE'); $('#priceTEReal').val(this.value);" onkeyup="$('#priceType').val('TE'); $('#priceTEReal').val(this.value.replace(/,/g, '.')); if (isArrowKey(event)) return; calcPriceTI();" />
			</div>
		</div>
	</div>
	<div class="form-group">
...
" onkeyup="$('#priceType').val('TI');if (isArrowKey(event))return; calcPriceTE(); this.value = this.value.replace(/,/g, '.'); if (parseInt(this.value) > getE('priceTE').value) this.value = getE('priceTE').value; if (isNaN(this.value)) this.value = 0;" />
	...
	<div class="form-group" <?php if (!$_smarty_tpl->tpl_vars['country_display_tax_label']->value||$_smarty_tpl->tpl_vars['tax_exclude_taxe_option']->value) {?>style="display:none;"<?php }?> >
		<label class="control-label col-lg-3 required" for="priceTI"><?php echo smartyTranslate(array('s'=>'Retail price with tax'),$_smarty_tpl);?>
</label>
		<div class="input-group col-lg-2">
			<span class="input-group-addon"><?php echo $_smarty_tpl->tpl_vars['currency']->value->prefix;?>
<?php echo $_smarty_tpl->tpl_vars['currency']->value->suffix;?>
			...
			<input id="priceTI" name="priceTI" type="text" required  disabled onchange="noComma('priceTI');" maxlength="27" onkeyup="$('#priceType').val('TI');if (isArrowKey(event)) return;  calcPriceTE();" />
		</div>
...
<?php $_tmp3=ob_get_clean();?><?php echo smartyTranslate(array('s'=>'The sum of prices of the products in the pack is %s%s%s','sprintf'=>array($_smarty_tpl->tpl_vars['currency']->value->prefix,$_tmp3,$_smarty_tpl->tpl_vars['currency']->value->suffix)),$_smarty_tpl);?>
</p><?php }?>
	</div>
...
<?php echo $_smarty_tpl->tpl_vars['currency']->value->suffix;?>
				...
				<input type="hidden" id="unit_price" name="unit_price" type="text" value="<?php echo sprintf('%.6f',$_smarty_tpl->tpl_vars['unit_price']->value);?>
