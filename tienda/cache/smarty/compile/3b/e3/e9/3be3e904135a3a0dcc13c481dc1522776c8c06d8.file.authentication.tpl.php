<?php /* Smarty version Smarty-3.1.19, created on 2018-01-10 14:17:18
         compiled from "/var/www/vhosts/eurekadigital.com.co/httpdocs/tienda/themes/minimal2017/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13597082885a5666be2ba2b2-33318247%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3be3e904135a3a0dcc13c481dc1522776c8c06d8' => 
    array (
      0 => '/var/www/vhosts/eurekadigital.com.co/httpdocs/tienda/themes/minimal2017/authentication.tpl',
      1 => 1513830570,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13597082885a5666be2ba2b2-33318247',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a5666beb97368_69411848',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a5666beb97368_69411848')) {function content_5a5666beb97368_69411848($_smarty_tpl) {?>
...
<?php }?>" />
			...
			<?php if ($_smarty_tpl->tpl_vars['b2b_enable']->value) {?>
			<!--Modificado ale estudiante-->
			<div class="account_creation">
				<h3 class="page-subheading">INFORMACIÓN DEL ESTUDIANTE</h3>
				<p class="form-group">
					<label for="">Nombres<sup>*</sup></label>
					<textarea class="form-control" id="company" name="company" cols="26" rows="3"value="<?php if (isset($_POST['company'])) {?><?php echo $_POST['company'];?>
<?php }?>" data-validate="isName"></textarea>
...
<?php }?>" />
		...
		<?php }?>
			...
			<br> <input type="checkbox" required> Acepto la <span id="pd"><a href="https://www.eurekadigital.com.co/tienda/index.php?id_cms=4&controller=cms" target="_blank">Política de proteccion de datos</a></span><br><br>
		<?php }?>
		<?php echo $_smarty_tpl->tpl_vars['HOOK_CREATE_ACCOUNT_FORM']->value;?>
