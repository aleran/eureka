...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5a5a217b8f04d5_49270356',
  'has_nocache_code' => true,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a5a217b8f04d5_49270356')) {function content_5a5a217b8f04d5_49270356($_smarty_tpl) {?>
	<!-- Block CMS module -->
			<section id="informations_block_left_1" class="block informations_block_left">
			<p class="title_block">
				<a href="https://eurekadigital.com.co/tienda/index.php?id_cms_category=1&amp;controller=cms">
					Información				</a>
			</p>
			<div class="block_content list-block">
				<ul>
																							<li>
								<a href="https://eurekadigital.com.co/tienda/index.php?id_cms=1&amp;controller=cms" title="Envío">
									Envío
								</a>
							</li>
																								<li>
								...
								<a href="https://eurekadigital.com.co/tienda/index.php?id_cms=4&amp;controller=cms" title="Protección de datos">
									Protección de datos
																						...
																						<li>
							<a href="https://eurekadigital.com.co/tienda/index.php?controller=stores" title="Nuestras tiendas">
								Nuestras tiendas
							</a>
						</li>
									</ul>
