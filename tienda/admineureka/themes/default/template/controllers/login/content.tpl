...
<div id="login-panel">
	...
	<div id="shop-img"><img src="{$img_dir}preston-login@2x.png" alt="{$shop_name}" width="130px" height="118.5px" /></div>
	...
	<div id="login-footer">
		<p class="text-center text-muted">
			<a href="https://www.solucionesartech.com/" onclick="return !window.open(this.href);">
				&copy; Tienda creada por Artech Soluciones S.A.S; {$smarty.now|date_format:"%Y"}
			</a>
		</p>
		<!--<p class="text-center">
